    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <a href="{{ route('admin.products') }}">
                            <div class="text-tiny">{{__('messages.Products')}}</div>
                        </a>
                    </li>
                    <li>
                        <i class="icon-chevron-right"></i>
                    ...
                    <li>
                        <div class="text-tiny">{{__('messages.Add Product')}}</div>
                    </li>
                </ul>
            </div>
            <!-- form-add-product -->
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.product.store') }}">
                ...
                <div class="wg-box">
                    <fieldset class="name">
                        <div class="body-title mb-10">{{__('messages.Product name')}}
                    ...
                    <div class="gap22 cols">
                        ...
                        <fieldset class="brand">
                            <div class="body-title mb-10">{{__('messages.Brand')}} <span class="tf-color-1">*</span>
                            </div>
                            <div class="select">
                    ...
                    <fieldset class="shortdescription">
                        <div class="body-title mb-10">{{__('messages.Short Description')}} <span class="tf-color-1">*</span></div>
                        <textarea class="mb-10 ht-150" name="short_description" placeholder="{{__('messages.Short Description')}}" tabindex="0" aria-required="true" required="">{{ old('short_description') }}</textarea>
                        <div class="text-tiny">
                    ...
                    <fieldset class="description">
                        <div class="body-title mb-10">{{__('messages.Description')}} <span class="tf-color-1">*</span>
                        </div>
                        <textarea class="mb-10" name="description" placeholder="{{__('messages.Description')}}" tabindex="0" aria-required="true" required="">{{ old('description') }}</textarea>
                        <div class="text-tiny">Do not exceed 100 characters when entering the
                            product name.</div>
                    </fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            ...
                            <div id="upload-file" class="item up-load">
                                <label class="uploadfile" for="myFile">
                                    ...
                                    <span class="body-text">{{__('messages.Drop your images here or select')}}
                                        <span class="tf-color">{{__('messages.click to browse')}}</span>
                                    </span>
            ...
            <img src="images/upload/upload-1.png" alt="">
                    ...
                    <div class="cols gap10">
                        <button class="tf-button w-full" type="submit">{{__('messages.Add Product')}}</button>
                    </div>
                </div>
            </form>
            <!-- /form-add-product -->
